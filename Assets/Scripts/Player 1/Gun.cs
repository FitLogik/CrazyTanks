...
public class Gun : MonoBehaviour
{
    ...
    public float powerIncreaseRate = 8f; // скорость увеличения силы выстрела
    private float currentPower; // текущая сила выстрела
    ...
    {
        Bullet projectile = Instantiate(projectilePrefab, firePoint.position, firePoint.rotation).GetComponent<Bullet>();
